...
def the_3in1_game():
    ...
    name=input("Well this is awkward, we forgot to ask your name\n What's your name?\n")
    game=input("Now then let's select a game you what to play:\n 1.Hangman\n 2.Rock,Paper,Scissors\n 3.TIC-TAC-TOE\n 4.Exit :(\n What's your choose? (1-4)\n")
    ...
    if game=='1':
        def hangman(name):
            ...
            while turns > 0:
                ...
                if failed == 0:
                    ...
                    replay=input("That was a good game, want to try that again:\n (y/n)\n")
                ...
                if guess not in word:
                    ...
                    if turns == 0:
                        print("You Loose")
                        print("The word is: ", word)
                        replay=input("I belive you can win this game, want to try that again:\n (y/n)\n")
        ...
        def tictactoe(name):
            ...
            def game():
                ...
                play=input("You are about to play Tic-Tac_toe:\n 1.Play\n 2.Exit: (Enter option 1 or 2)")
                if play == '1':
                    print("You need 2 players to play this game")
                    name1=input("Enter the second player name:")
